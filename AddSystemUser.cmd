...
chcp 65001 > nul
title Add System variables And User variables
setlocal
cls

set _TITLE=Add System variables And User variables
...
set _PATH=%~dp0
set _BACKUP_SYSTEM=AddSystem.txt
set _BACKUP_USER=AddUser.txt
set _FILE=Path.txt
...
setx /m path "%_CURRENT_PATH_SYSTEM%%_MASS_SYSTEM%"
echo.

echo.
echo COMMAND: System PATH Update
echo STATUS: %_COLOR_GREEN%%_CURRENT_PATH_SYSTEM%%_MASS_SYSTEM%%_COLOR_CYAN%
echo.
...
setx path "%_CURRENT_PATH_USER%%_MASS_USER%"
echo.

echo.
echo COMMAND: User PATH Update
echo STATUS: %_COLOR_GREEN%%_CURRENT_PATH_USER%%_MASS_USER%%_COLOR_CYAN%
echo.
